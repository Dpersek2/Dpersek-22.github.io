...
const Work = (isDarkMode) => {
  return (
    ...
    Welcome to my projects portfolio the following projects include: Web Development,
    Mobile App Development, and an Entrepreneurial Venture!
    </p>
        ...
        {workData.map((project, index)=>(
            ...
            style={{backgroundImage: `url(${project.bgImage})`}}>
                ...
                justify-between duration-500 group-hover:bottom-7'>
                    ...
                    <div className='border rounded-full border-black w-9 aspect-sqaure flex items-center justify-center shadow-[2px_2px_0_#000] 
                    group-hover:bg-blue-300 transistion'>
